        ...
        static void Main()
        {
            ...
            RenderLoop.Run(form, () =>
            {
                ...
                if (fpsTimer.ElapsedMilliseconds > 1000)
                {
                    ...
                    form.Text = string.Format("D3D11.1Rendering - FPS: {0:F2} ({1:F2}ms/frame)", fps, (float)fpsTimer.ElapsedMilliseconds / fpsFrames);
